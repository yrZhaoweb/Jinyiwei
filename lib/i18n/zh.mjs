export default {
  ...
  "install.summary.partialFail": "插件已安装，但技能安装失败",
  "install.summary.dryRunOk": "模拟运行完成 — 未做任何变更",
  "install.deployingAgents": "部署代理工作区",
  "install.agentDryRun": "将在 {path} 创建 {agent} 工作区",
  "install.clawhubNotFound": "未找到 clawhub — 跳过技能安装",
  "install.clawhubSkipped": "安装 clawhub 以启用技能安装",
  ...
  "init.prompt.autoInstallSkills": "启动时自动安装技能列表？[yes/no]（默认：yes）：",
  "init.prompt.skillsManifest": "技能清单路径（默认：manifests/preinstalled-skills.json）：",
  "init.saved": "配置已保存",
  "init.backupCreated": "备份已保存到 {path}",
