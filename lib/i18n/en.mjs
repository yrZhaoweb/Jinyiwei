export default {
  ...
  "install.summary.partialFail": "Plugin installed but skill installation failed",
  ...
  "install.clawhubNotFound": "clawhub not found — skipping skills installation",
  "install.clawhubSkipped": "Install clawhub to enable skill installation",
  ...
  "init.prompt.autoInstallSkills": "Auto-install listed skills on bootstrap? [yes/no] (default: yes): ",
  "init.prompt.skillsManifest": "Skills manifest path (default: manifests/preinstalled-skills.json): ",
  "init.saved": "Configuration saved",
  "init.backupCreated": "Backup saved to {path}",
