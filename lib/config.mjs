...
export function sanitizeConfig(config) {
  ...
  normalized.models.chat = typeof normalized.models.chat === "string" ? normalized.models.chat.trim() : "";
  normalized.models.watch = typeof normalized.models.watch === "string" ? normalized.models.watch.trim() : "";
  ...
  for (const [groupName, model] of Object.entries(normalized.models.groups)) {
    normalized.models.groups[groupName] = typeof model === "string" ? model.trim() : "";
  }
