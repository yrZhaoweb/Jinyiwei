...
export function installCommand(args) {
  ...
  if (skipSkills) {
    if (!isJson) {
      log.step(7, totalSteps, t("install.installingSkills", { count: "0" }));
    ...
    if (!isJson) log.step(7, totalSteps, t("install.installingSkills", { count: String(manifest.skills.length) }));
