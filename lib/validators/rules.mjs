...
export function validateRules() {
  ...
  try {
    ...
    assert(addressingRule.includes("`WatchAgent`"), "addressing rule must include WatchAgent naming", errors);
    ...
    for (const [agentName, templatePath] of Object.entries(INTERNAL_RESPONSE_TEMPLATES)) {
